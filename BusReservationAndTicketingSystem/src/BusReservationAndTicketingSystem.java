...
System.out.println("***************************************");
System.out.println("** 1.)Jaipur        | Rs600 |   "+available[1]+"   **");
System.out.println("** 2.)Banglore      | Rs870 |   "+available[2]+"   **");
System.out.println("** 3.)Mumbai        | Rs1150 |   "+available[3]+"   **");
System.out.println("** 4.)Ladakh        | Rs2000 |   "+available[4]+"   **");
System.out.println("** 5.)Chennai       | Rs650 |   "+available[5]+"   **");
System.out.println("***************************************");
System.out.println("***************************************\n");
...
String dest[] = { " ","Jaipur ", "Banglore ", "Mumbai", "Ladakh", "Chennai"};
double fare[] = {0, 600,870,1150,2000,650};
